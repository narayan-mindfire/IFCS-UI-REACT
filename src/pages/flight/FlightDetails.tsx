            ...
            <div className="flex font-roboto items-stretch border rounded-full border-border-muted w-full bg-white overflow-x-auto">
              {tabKeys.map((tab, index) => (
                ...
                >
                  ...
                  ${activeTab === tab
                        ? "text-bg-button"
                        : (tab === "Invoice" || tab === "Labels/Reports" || tab === "Deliveries" || tab === "Content Locn" || tab === "Galleys" || tab === "Food Orders")
                          ? "text-gray-400 cursor-not-allowed"
                          : "text-text-secondary hover:text-bg-button/80"
                      }`}
                    disabled={tab === "Invoice" || tab === "Labels/Reports" || tab === "Deliveries" || tab === "Content Locn" || tab === "Galleys" || tab === "Food Orders"}
                  >
                    <span
